...
import { ShieldCheck, TimerReset, Siren, X, Link2, Copy, Check } from "lucide-react-native";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.guardianCard}>
        ...
        <View style={styles.guardianInfo}>
          ...
          <Text style={styles.guardianStatus}>Following your route · Updates every 30s</Text>
        </View>
      </View>
      ...
      <View style={[styles.checkinCard, isDeadZoneActive && styles.checkinCardActive]}>
        <View style={styles.checkinRow}>
          <View style={styles.checkinLeft}>
            ...
            >
              <TimerReset size={16} color={isDeadZoneActive ? colors.neonOrange : colors.textSecondary} />
            </View>
          ...
          {isDeadZoneActive ? (
            ...
            <Switch
              ...
              trackColor={{ false: colors.surfaceLight, true: "rgba(255, 138, 61, 0.45)" }}
              thumbColor={isDeadZoneActive ? colors.neonOrange : colors.textSecondary}
            />
          )}
        </View>
        ...
        {isDeadZoneActive && (
          <View style={styles.checkinActions}>
            <TouchableOpacity style={styles.imSafeBtn} onPress={() => onToggleDeadZone(false)}>
